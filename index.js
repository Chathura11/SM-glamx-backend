...
app.use(cors({
    origin: ['http://localhost:3000','http://localhost:5173','https://sm-glamx-frontend.vercel.app','https://sm-glamx-frontend.vercel.app/'], // Replace with your actual frontend domain
